...
const HorrorItems = () => {
  ...
  async function getMovies() {
    const res = await axios.get(`https://mp2-api-json-server.onrender.com/movies?genre_ids_like=27`) //change this if we want to display other categories in carousel view
    setMovies(res.data)
